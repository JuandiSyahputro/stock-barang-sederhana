                ...
                <div class="container-fluid px-4">
                    <div class="card mb-4 mt-4 col-lg-8">
                        <div class="card-header">
                            <h2>Create Data <p class="king d-inline"></p>
                            </h2>
                        </div>
                        <div class="card">
                            <form action="/dashboard/tables" method="post">
                                @csrf
                                ...
                                <div class="mx-3 mb-3">
                                    ...
                                    <label for="tglKeluar" class="mb-2 fw-semibold">Tanggal Keluar
                                    </label>
                                    <input type="date" class="form-control" name="tgl_keluar" id="tgl_keluar"
                                        placeholder="Tanggal Keluar">
                                    <button type="submit" class="btn btn-success mt-2 mb-1 mt-4">Submit</button>
                            </form>
                        </div>
                    </div>
                </div>
