            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link {{ Request::is (Request::path()) ? 'active' : '' }}" href="/dashboard">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-5 mb-3">Welcome, {{ auth()->user()->name }}</h1>
                    <a href="/dashboard/exportpdf" class="btn btn-danger mb-3" target="_blank">Print <i
                            class="fa-solid fa-file-pdf"></i></a>
                    <a href="/dashboard/exportexcel" class="btn btn-success mb-3">Export <i
